...
class handler(BaseHTTPRequestHandler):
    ...
    def _render(self) -> str:
        ...
        learn_card = _card("Научение → действие (реальное, НЕ LLM)",
            ...
            + f'<div class="meta" style="margin-top:.5rem">бумажный капитал: <b>{eq_txt}</b> · сделок: <b>{ls.get("trades",0)}</b> · винрейт: <b>{ls.get("winrate",0):.2f}</b> · '
...
<body><div class="wrap">
  <h1>&#128062; Bentlyk <a href="/api/live" style="font-size:.8rem;color:var(--acc);text-decoration:none">&#9654; live</a> <a href="/api/trading" style="font-size:.8rem;color:var(--acc);text-decoration:none">&#128200; трейдинг</a> <a href="/api/terminal" style="font-size:.8rem;color:var(--acc);text-decoration:none">&#128202; терминал</a></h1>
